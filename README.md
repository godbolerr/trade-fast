...
To optimize the TradeFast application for production, run:
...
[Doing microservices with JHipster]: https://jhipster.github.io/documentation-archive/v4.5.2/microservices-architecture/
